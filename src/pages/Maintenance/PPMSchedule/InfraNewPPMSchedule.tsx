...
const InfraNewPPMSchedule = (props: any) => {
  ...
  const getOptions = async (firstDate: any, lastDate: any) => {
    ...
    const payload: any = {
      ...
      N_W_D: 0,
      LOCATION:
        watchAllFields?.ASSETNAME?.length > 0
          ? [watchAllFields?.LOCATION_ID]
          : data,
      ASSETGROUP:
        watchAllFields?.ASSETNAME?.length > 0
  ...
  const getOptionFilter = async () => {
    const payload = {
      LOCATION_ID:
        watchAllFields?.LOCATION_ID !== undefined
          ? watchAllFields?.LOCATION_ID?.LOCATION_ID
          : null,
      ASSETGROUP_ID:
        watchAllFields?.ASSETGROUP_ID !== undefined
          ? watchAllFields?.ASSETGROUP_ID?.ASSETGROUP_ID
          : null,
      ASSETTYPE_ID:
        watchAllFields?.ASSETTYPE_ID !== undefined
          ? watchAllFields?.ASSETTYPE_ID?.ASSETTYPE_ID
          : null,
    };
  ...
  useEffect(() => {
    if (watchAllFields?.ASSETGROUP_ID) {
      const dataField: any = options?.assetType?.filter(
        (f: any) =>
          f.ASSETGROUP_ID === watchAllFields?.ASSETGROUP_ID?.ASSETGROUP_ID
      );
      setType(dataField);
  ...
  useEffect(() => {
    if (
      watchAllFields?.ASSETTYPE_ID !== "" ||
      watchAllFields?.ASSETTYPE_ID !== null
    ) {
      (async function () {
  ...
  const nodeTemplate: any = (node: any, options: any) => {
    ...
    return (
      <div className="flex gap-3 flex-wrap">
        {node.is_asset === 1 ? (
          <>
            <div className="imagefolder1"></div>
          </>
        ) : (
          <>
  ...
  const getEquimentHierarchy = async () => {
    try {
      ...
      const res = await callPostAPI(
        ENDPOINTS.GET_HIERARCHY_FOLDER_LIST,
        payload
      );
      if (res?.FLAG === 1) {
                ...
                <div className="col-span-2 p-[8px] border-r border-gray-200">
                  ...
                  <div className="">
                    <Accordion activeIndex={0}>
                      ...
                      <AccordionTab header="Type of work"></AccordionTab>
                    ...
                    <div className="flex flex-col gap-[36px]">
                      <div className="mt-2 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-2">
                        <div className="">
                          ...
                          <p className="Text_Primary Alert_Title">Text123</p>
                        </div>
                        <div className="">
                          <label className="Text_Secondary Helper_Text  ">
                            Priority
                        ...
                        <div className="">
                          ...
                          <p className="Text_Primary Alert_Title">Text1235</p>
                        </div>
                        ...
                        <div className="flex flex-col gap-6 equpmentContainer">
                          <div>
                            ...
                            <p className="Text_Primary Helper_Text  ">
                              Pneumatic Actuated Diaphragm Valve HCL Diluting
                              Tank to HCL Dosing Pump 2 - DN15
                            </p>
                          </div>
                          <div>
                            <label className="Text_Secondary Helper_Text">
                            ...
                            <p className="Text_Primary Helper_Text  ">
                              Instrumentation Chain Conveyor Boiler Ash Handling
                              System
                            </p>
                          </div>
                          <div>
